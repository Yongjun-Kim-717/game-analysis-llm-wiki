...
- 장르/태그: action, adventure, casual, massively-multiplayer, rpg, free-to-play [S6]
- 플랫폼: windows, mac [S6]
- 근거 수준: high
- 검색 범위: standard
...
Join over 260 million players worldwide in MapleStory, the world’s biggest 2D MMORPG adventure! Play now for free. [S6][S7]
...
2. 전투 보상 선택 [inference]
3. 숙련 기반 반복 [inference]

## 핵심 재미 가설

- 현재 입력 자료 기준으로 이 게임의 재미는 선택, 반복, 보상, 숙련 또는 조합의 순환에서 발생한다고 가정한다. [S6][S7][inference]
...
- [S1] Steam Store Search (tier-1, candidate) https://store.steampowered.com/search/?term=MapleStory
- [S2] Official Site Search (tier-1, candidate) https://www.google.com/search?q=MapleStory+official+site
- [S3] Press Kit Search (tier-2, candidate) https://www.google.com/search?q=MapleStory+press+kit+developer
- [S4] Public Wiki Search (tier-3, candidate) https://www.google.com/search?q=MapleStory+game+wiki
- [S5] MobyGames Search (tier-3, candidate) https://www.mobygames.com/search/?q=MapleStory
- [S6] Steam Store - MapleStory (tier-1, fetched) https://store.steampowered.com/app/216150/
- [S7] Wikipedia - MapleStory (tier-3, fetched) https://en.wikipedia.org/wiki/MapleStory
- Evidence detail: wiki/evidence/maplestory-sources.md
...
- [Evidence](../evidence/maplestory-sources.md)
- [Wiki Index](../index.md)
...
- Storefront Agent: completed - 1 confirmed source(s), 1 candidate source(s), 2 claim(s).
